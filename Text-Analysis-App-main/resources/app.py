...
mandarin_vocabs_df = pd.read_csv("./resources/華語八千詞表20220314_整理.csv", encoding="utf-8")
first_vocabs = list(set(list(mandarin_vocabs_df["準備級一級"])))
second_vocabs = list(set(list(mandarin_vocabs_df["準備級二級"])))
elementary_vocabs = list(set(list(mandarin_vocabs_df["入門級"])))
basic_vocabs = list(set(list(mandarin_vocabs_df["基礎級"])))
advanced_vocabs = list(set(list(mandarin_vocabs_df["進階級"])))
higher_vocabs = list(set(list(mandarin_vocabs_df["高階級"])))
fluence_vocabs = list(set(list(mandarin_vocabs_df["流利級"])))
